...
township_keyboards_dict = {
    ...
    "စ": [["စမ်းချောင်း"]],
    "ဆ": [['ဆိပ်ကြီးခနောင်တို',]],
    "တ": [['တာမွေ', 'တိုက်ကြီး', 'တောင်ဒဂုံ'], ['တောင်ဥက္ကလာပ', 'တွံတေး',]],
    "ထ": [['ထန်းတပင်']],
    "ဒ": [["ဒေါပုံ", "အရှေ့ဒဂုံ"], ["တောင်ဒဂုံ", "မြောက်ဒဂုံ"], ["ဒဂုံ", "ဒဂုံဆိပ်ကမ်း", "ဒလ"]],
    "ပ": [["ပုဇွန်တောင်", "ပန်းပဲတန်း"]],
    "ဗ": [["ဗိုလ်တထောင်", "ဗဟန်း"]],
    "မ": [["မင်္ဂလာဒုံ", "မင်္ဂလာတောင်ညွန့်"], ["မရမ်းကုန်း", "မြောက်ဒဂုံ"], ["မြောက်ဥက္ကလာပ"], ["မှော်ဘီ"]],
...
submission_confirmation_keyboard = ReplyKeyboardMarkup(
    [["အတည်ပြုပါသည်။", "အတည်မပြုပါ။"]], resize_keyboard=True, one_time_keyboard=True,
)
...
restart_keyboard = ReplyKeyboardMarkup(
    [["Restart", "Stop"]], resize_keyboard=True, one_time_keyboard=True,
)
